...
> **Repository:** [https://github.com/AadiHaldar/continuum-forge](https://github.com/AadiHaldar/continuum-forge)  
...
- [x] **Documentation:** `README.md`, `DEMO_SCRIPT.md`, and `VERIFICATION.md` included in repository root.
- [x] **Demo Video:** Maximum 3-minute video prepared following the `DEMO_SCRIPT.md` guidelines.
